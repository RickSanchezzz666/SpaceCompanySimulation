...
protected:
	...
	const long int _area; // Example: 78'800'000 KM
...
public:
	PlanetAbstract(long double mass, float radius, float day, long int area,
		...
		int magneticField, float lifeChance, int moonsNum) : _mass(mass), _radius(radius),
