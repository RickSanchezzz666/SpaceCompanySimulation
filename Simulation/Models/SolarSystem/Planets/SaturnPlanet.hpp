...
public:
	SaturnPlanet(std::string name, long double mass, float radius, float day, long int area,
		...
		int magneticField, float lifeChance, int moonsNum, int time, std::vector<std::string> moons, int id) : PlanetAbstract(name, mass, radius, day,
			...
			gravity, magneticField, lifeChance, moonsNum, time, moons, id) { std::cout << "Saturn Planet Generated...\n"; };
	...
	SaturnPlanet() : PlanetAbstract("Saturn", 5.6834E26L, 58232.0f, 10.656f, 42'700'000'000, 10759.22f, 9.58f, 134, 84, true, { 
		...
		}, 1.065f, 20000, 0.01f, 82, 135, __moons, 5) { std::cout << "Saturn Planet Generated...\n"; }
