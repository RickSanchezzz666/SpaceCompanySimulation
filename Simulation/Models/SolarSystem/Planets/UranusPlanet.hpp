...
public:
	UranusPlanet() : PlanetAbstract("Uranus", 8.6810E25L, 25362.0f, 17.24f, 8.115E9L, 30685.0f, 19.22f, 76, 49, true, {
		...
		}, 0.886f, 7500, 0.001f, 27, { "Miranda", "Ariel", "Umbriel", "Titania", "Oberon", "Cordelia", "Ophelia",
		"Bianca", "Cressida", "Desdemona", "Juliet", "Portia", "Rosalind", "Belinda", "Puck", "Caliban", "Sycorax",
		"Prospero", "Setebos", "Stephano", "Trinculo", "Francisco", "Margaret", "Ferdinand", "Perdita" }, 6, true, new AsteroidCluster("Uranus's Belt", "Uranus", 2500, { "C-type" }), "Class I gas giant") {
	}
};