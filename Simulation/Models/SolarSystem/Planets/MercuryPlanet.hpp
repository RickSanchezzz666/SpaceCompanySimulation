...
public:
	MercuryPlanet(std::string name, long double mass, float radius, float day, long int area,
		...
		int magneticField, float lifeChance, int moonsNum, int time, std::vector<std::string> moons, int id, bool belt) : PlanetAbstract(name, mass, radius, day,
			...
			gravity, magneticField, lifeChance, moonsNum, time, moons, id, belt) { std::cout << "Mercury Planet Generated...\n"; };

	MercuryPlanet() : PlanetAbstract("Mercury", 3E23L, 2439.7f, 59.f, 74'800'000, 87.969f, 0.4f, 700, 90, false, {}, 0.378f, 300, .00005f, 0, 18, {}, 1, false) { std::cout << "Mercury Planet Generated...\n"; };
