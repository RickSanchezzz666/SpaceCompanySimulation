...
private:
	std::vector<std::string> __moons = { "Metis", "Adrastea", "Amalthea", "Thebe", "Io", "Europa", "Ganymede", 
		...
		"Arche", "Iocaste", "Erinome", "Harmony", "Eupheme", "Thelxinoe", "Eirene", "Philophrosyne", };
public:
	JupiterPlanet(std::string name, long double mass, float radius, float day, long int area,
		...
		int magneticField, float lifeChance, int moonsNum, int time, std::vector<std::string> moons, int id) : PlanetAbstract(name, mass, radius, day,
			...
			gravity, magneticField, lifeChance, moonsNum, time, moons, id) { std::cout << "Jupiter Planet Generated...\n"; };
	...
	JupiterPlanet() : PlanetAbstract("Jupiter", 1.898E27L, 69911.0f, 9.925f, 61'420'000'000, 4332.6f, 5.20f, 165, 110, true, { 
		...
		}, 2.528f, 42000, 0.01f, 72, 75, __moons, 4) { std::cout << "Jupiter Planet Generated...\n"; }
