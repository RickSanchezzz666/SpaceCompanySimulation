#include "MercuryPlanet.hpp"

#include <iostream>

using std::cout;

void MercuryPlanet::showPlanetInfo() {
	cout << "Mercury Planet Properties:";
	cout << "\n   Mass (KG): " << _mass << " KG";
...
void MercuryPlanet::generatePlanet() {
	std::cout << "Mercury Planet Generated...\n";
}

void MercuryPlanet::destroyPlanet() {
	std::cout << "Mercury Planet Destroyed...\n";
}
