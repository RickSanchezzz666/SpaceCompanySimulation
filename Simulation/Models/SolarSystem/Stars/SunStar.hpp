...
public:
	SunStar(long double mass, float radius, long double area, float age, int temp, std::string starType,
		...
		StarsAbstract(mass, radius, area, age, temp, starType, luminosity, spectralClass, absoluteMagnitude, distance, name, time, id) { std::cout << "Sun Star generated...\n"; };

	SunStar() : StarsAbstract(1.9885E30L, 696'000, 6.09E12L, 4.6f, 5772, "G (White Yellow)", "V", "G2 V", 4.83f, 26660, "Sun", 15, 0) { std::cout << "Sun Star generated...\n"; };
